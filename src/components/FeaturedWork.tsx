    ...
    <section id="work" className="featured-work">
      <div className="container">
        ...
        >
          ...
          <p>
            Strategy, design, and engineering brought together as one focused
            digital experience.
          </p>
        </motion.div>
          ...
          {projects.map((p, i) => {
            ...
            return (
              <motion.article
                ...
                className={`work-card work-card-${p.accent}`}
              >
